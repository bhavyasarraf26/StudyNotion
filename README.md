# StudyNotion: An Ed-Tech Platform (MERN Application)

![mainpage](https://github.com/user-attachments/assets/a7c4afa9-39f8-4b84-8be7-f81f18cc311b)
...
![architecture](https://github.com/user-attachments/assets/e82949bd-3222-4cdf-9a2a-9810373ba5ab)
...
![schema](https://github.com/user-attachments/assets/d513717c-7073-4b3e-95f6-dd63086af728)
...
2. Navigate to `StudyNotion` directory and edit `.env` file.
3. Navigate to `StudyNotion > server` directory and edit `.env` file.
